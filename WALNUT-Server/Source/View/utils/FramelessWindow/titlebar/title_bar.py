...
class TitleBar(QWidget):
    ...
    def setDarkMode(self, b: bool):
        self.isDarkMode = b
        self.minBtn.isDarkMode = b
        self.closeBtn.isDarkMode = b
        self.maxBtn.isDarkMode = b
        self.minBtn.update()
    ...
    def SetHeight(self, height):
        ...
        self.minBtn.setFixedHeight(height)
        self.maxBtn.setFixedHeight(height)
        self.closeBtn.setFixedHeight(height)
